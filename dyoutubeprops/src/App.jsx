...
// that array consists of multiple objects
...
function App() {
  ...
  return (
    <>
      ...
      {Sdata.map(ncard)}{" "}
      {/*Here ncard is a callback function, i.e. function called as an argument for another function. i.e. map is a function and ncard (also a function) is called as an argument inside the map function*/}
    </>
  );
}
